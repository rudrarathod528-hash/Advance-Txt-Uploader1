...
async def drm_handler(bot: Client, m: Message):
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            # --- NEW FIX: Remove Appx/ClassX tracking asterisks from URL ---
            ...
            # ---------------------------------------------------------------
                ...
                # --- NEW FIX: Inject Akamai/Classx headers ---
                elif "classx.co.in" in url or "akamai.net" in url: cmd = f'yt-dlp --add-header "Referer: https://player.akamai.net.in/" --add-header "User-Agent: Dalvik/2.1.0 (Linux; U; Android 16; M2012K11AI Build/BP4A.251205.006)" -f "{ytf}" "{url}" -o "{namef}.mp4"'
                # ---------------------------------------------

...
BOT_TOKEN = environ.get("BOT_TOKEN", "8831009787:AAHBYplC5pYGsEJtpWiIYcIsosmSz4wLibk")

OWNER = int(environ.get("OWNER", "5892781710"))
CREDIT = environ.get("CREDIT", " @CinderellaContactBot")
cookies_file_path = os.getenv("cookies_file_path", "youtube_cookies.txt")

TOTAL_USER = os.environ.get('TOTAL_USERS', '5892781710').split(',')
